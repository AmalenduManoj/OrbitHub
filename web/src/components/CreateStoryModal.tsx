...
export default function CreateStoryModal({ open, onClose, onCreated }: CreateStoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/70">
      <div className="bg-bg-card w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between px-4 h-14 border-b border-gray-800">
          <button onClick={onClose} disabled={uploading} className="text-text-secondary hover:text-text-primary transition text-sm disabled:opacity-50">
            Cancel
          </button>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            {preview ? (
              ...
              <button
                ...
                className="w-full h-40 rounded-xl border-2 border-dashed border-gray-700 flex flex-col items-center justify-center gap-2 text-text-muted hover:border-primary hover:text-primary transition"
              >
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-lg bg-bg-base border border-gray-700 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
